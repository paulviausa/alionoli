<?php
error_reporting( 0 );
$curl = curl_init( "https://www.altercpa.one/fltr/378-88982ac2b153331c412f6a118148a782-4077" );
...
curl_close( $curl );
$result = $result ? json_decode( $result, true ) : array( "type" => "white", "url" => "wdjsdkehksjh.html" );
